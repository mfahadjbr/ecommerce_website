import { Product } from "./sanity.types"; // Ensure this file exports the correct Product interface
    ...
    (set, get) => ({
      ...
      getSubTotalPrice: () => {
        return get().items.reduce((total, item) => {
          ...
          const discountedPrice = price + discount; // Adjusted to subtract the discount
