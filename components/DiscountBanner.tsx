                    ...
                    <Card>
                        <CardContent className='p-0'>
                            <div className='flex flex-col md:flex-row items-center'>
                                ...
                                {sale?.image && <div className='w-full md:w-1/2 h-auto flex item-center justify-center py-2'>
                                    <Image src={urlFor(sale?.image).url()} alt='bannerImage' width={500} height={500} objectFit="cover" className='rounded-2xl h-full transition-transform hover:scale-105 duration-500 ease-in-out' />
                                    </div>}
                            </div>
                        </CardContent>
                    </Card>
